...
function insertNextButton() {
  ...
  nextButtonDiv.innerHTML = '<button class="btn btn-outline-warning m-3" onclick="nextQuery()">Next Page</button>'
}

function insertPreviousButton() {
  prevButtonDiv = document.getElementById('prevButtonDiv');
  prevButtonDiv.innerHTML = '<button class="btn btn-outline-warning m-3" onclick="previousQuery()">Previous Page</button>'
}
